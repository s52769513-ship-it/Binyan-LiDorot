  ...
  try {
      ...
      await Promise.all([
        fetchAirtableRecords(TABLES.PARENTS, {
          fields: [
            ...
            P.ID_NUMBER, P.NICKNAME, P.TITLE_AFTER, P.BEN_REB,
            P.BENEFICIARY_NAME, P.HOME_PHONE, P.ROLE, P.SYNAGOGUE,
            P.BANK_NAME, P.BANK_BRANCH, P.BANK_ACCOUNT, P.CHARGE_DAY,
            P.STANDING_ORDER_TYPE, P.STANDING_ORDER_ID, P.TEACHER_CLASS_IDS, P.EXTRA_PHONE,
          ],
        }),
    ...
    const parents = rawParents
      ...
      .map(r => ({
        ...
        // New fields
        id_number:           String(r.fields[P.ID_NUMBER] || ''),
        nickname:            selectName(r.fields[P.NICKNAME]),
        title_after:         selectName(r.fields[P.TITLE_AFTER]),
        ben_reb:             String(r.fields[P.BEN_REB] || ''),
        beneficiary_name:    String(r.fields[P.BENEFICIARY_NAME] || ''),
        home_phone:          String(r.fields[P.HOME_PHONE] || ''),
        role:                selectNames(r.fields[P.ROLE]),
        synagogue:           selectName(r.fields[P.SYNAGOGUE]),
        bank_name:           String(r.fields[P.BANK_NAME] || ''),
        bank_branch:         Number(r.fields[P.BANK_BRANCH]) || null,
        bank_account:        Number(r.fields[P.BANK_ACCOUNT]) || null,
        charge_day:          Number(r.fields[P.CHARGE_DAY]) || null,
        standing_order_type: selectName(r.fields[P.STANDING_ORDER_TYPE]),
        standing_order_id:   Number(r.fields[P.STANDING_ORDER_ID]) || null,
        teacher_class_ids:   (r.fields[P.TEACHER_CLASS_IDS] as string[]) || [],
        extra_phone:         String(r.fields[P.EXTRA_PHONE] || ''),
        synced_at: syncedAt,
      }))
