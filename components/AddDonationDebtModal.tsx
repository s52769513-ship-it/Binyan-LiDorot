...
/**
 * הוספת חוב מגבית — יוצר PP מגבית (pp_type='donation') לבן אדם מתוך הכרטיס.
 * השם נגזר אוטומטית ("דמי מגבית MM/YYYY") כי הרשומה כבר מקושרת לבן אדם,
 * ולכן צריך רק סכום וחודש.
 */
