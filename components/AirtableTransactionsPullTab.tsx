      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-5">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">
            מושך את <b>כל</b> התנועות מטבלת התנועות ב-Airtable — בכל אמצעי תשלום (כולל הו&quot;ק ואשראי). תנועות בקטגוריית &quot;בנין לדורות&quot; נמשכות רק מ-04/2026 ואילך — מה שלפני מטופל בייבוא חובות ישנים. <b>רק</b> תנועות בקטגוריית &quot;בנין לדורות&quot; מקושרות ל-PP שכ&quot;ל, ורק תנועות &quot;מגבית&quot; מקושרות ל-PP מגבית — כל קטגוריה אחרת (משכורות, הוצאות וכו&apos;) נכנסת בלי קישור לשום תשלום מתוכנן.
          </p>
          {lastRun.lastRun && (
